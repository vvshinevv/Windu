...
public class GPSProvider extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            //Log.i("센서상태 테스트", Boolean.toString(isGPSEnabled)+"/"+Boolean.toString(isNetWorkEnabled));
                ...
                if (isNetWorkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            ...
                            //Log.i("네트워크 테스트", Double.toString(lat)+"/"+Double.toString(lon));
                       }
                    }
                }
                    ...
                    if (location == null) {                  // LocationManager.GPS_PROVIDER
                        ...
                        if (locationManager != null) {
                            ...
                            if (location != null) {
                                lat = location.getLatitude();
                                lon = location.getLongitude();
                                //Log.i("GPS 테스트", Double.toString(lat)+"/"+Double.toString(lon));
                            }
                        }
                    }
                }
    ...
    public void showSettingAlert() {
        ...
        alertDialog.setMessage("GPS 를 사용하고 있지 않습니다. 설정하시겠습니까?");
